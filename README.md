...
![alt text](https://raw.githubusercontent.com/skunksecond/bayleef/refs/heads/main/images/ss61026.png "the UI and software as of June 9th, 2026")

## Quickstart

There isn't really anything right now but if you'd like to check out what there is, just clone the repository and run the main.py file.
...
* A keyboard and a ~~a PSP joystick~~ a trackpad for mouse controls, as well as a touch screen
* A good battery life
